...
func HelloHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.StdError(ctx, nil, err, "[HelloHandler][GetProductFromDB] ID not found")
	...
	if err != nil {
		log.StdError(ctx, nil, err, "[HelloHandler][CalculateDiscount] wrong CalculateDiscount value")
